...
public class SprintTableEmailPlugin  extends ExemplarVeloxServerPlugin<TableToolbarContext> implements TableToolbarPlugin {
    @Override
    ...
    protected PluginResult run(TableToolbarContext ctx) throws Throwable {
        List<DataRecord> sprints = ctx.getDataRecordList();
        execute(sprints);
